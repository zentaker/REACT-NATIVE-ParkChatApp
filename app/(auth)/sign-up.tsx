...
export default function SignUpScreen() {
  ...
  async function handleSignUp() {
    ...
    try {
      ...
      Alert.alert("No se pudo crear la cuenta", error instanceof Error ? error.message : "Intentalo otra vez.");
    } finally {
    ...
    <SafeAreaView style={styles.screen}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Tu perfil se muestra por nombre, no por ubicacion exacta.</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          >
            <Text style={styles.primaryText}>{isSubmitting ? "Creando..." : "Crear cuenta"}</Text>
          </Pressable>
        </View>
